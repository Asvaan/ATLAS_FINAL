        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="text-xs font-semibold text-white block">Unlimited Resource Traversals</span>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="text-xs font-semibold text-white block">Secure Local AI Summaries</span>
                <span className="text-[11px] text-gray-500 mt-0.5 block leading-relaxed">
